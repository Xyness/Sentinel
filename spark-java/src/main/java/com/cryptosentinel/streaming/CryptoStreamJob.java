package com.cryptosentinel.streaming;

import com.cryptosentinel.features.FeatureAssembler;
...
public class CryptoStreamJob {
    ...
    private static final String DEFAULT_CHECKPOINT_PATH = "data/checkpoints/cryptosentinel";
    ...
    public static void main(String[] args) throws Exception {
        ...
        SparkSession spark = SparkSession.builder()
                .appName("CryptoSentinel-Streaming")
                .getOrCreate();
